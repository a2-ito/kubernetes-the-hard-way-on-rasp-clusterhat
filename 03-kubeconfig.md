...
for instance in 1 2 3; do
  gcloud compute scp --zone=australia-southeast1-a --ssh-key-file=~/.ssh/key/id_rsa \
     ./keys/kube-proxy.kubeconfig ./keys/kube-controller-manager.kubeconfig \
     ./keys/kube-scheduler.kubeconfig ./keys/admin.kubeconfig akihiko@master-${instance}:~
done
```
